if CLIENT then local langs = {}
	langs[ "zh-CN" ] = {
		...
		[ "it_storage1" ] 	= "储藏箱", [ "dit_storage1" ] 		= "可以存放15个物品.",
		[ "it_storage2" ] 	= "大储藏箱", [ "dit_storage2" ] 	= "可以存放40个物品.",
		[ "it_bucket" ]     = "储物桶",  ["dit_bucket"]         = "可以存放5个物品.",
	...
	langs[ "en" ] = {
		...
		[ "it_storage1" ] 	= "Storage Crate", [ "dit_storage1" ] 		= "Can hold up to 15 items.",
		[ "it_storage2" ] 	= "Big Storage Crate", [ "dit_storage2" ] 	= "Can hold up to 40 items.",
		[ "it_bucket" ]     = "Storage Bucket", ["dit_bucket"]          = "Can hold up to 5 items.",
