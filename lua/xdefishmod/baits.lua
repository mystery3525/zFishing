...
if true then local it = "ba_pan"
	local ITEM = {
		...
		Rarity = 1,
		Consume = 20,
		PhysSound = "MetalGrate.BulletImpact",
		Level = 5,
		Price = 500
		}
...
if true then local it = "ba_bread"
	local ITEM = {
		Name = "#xdefm."..it,
		Type = "Bait",
		Model = "models/props_2fort/lunchbag.mdl",
		Price = 1000,
		Helper = "#xdefm.d"..it,
		Rarity = 2,
		Consume = 20,
...
if true then local it = "ba_bomb"
	local ITEM = {
		...
		Type = "Bait",
		Model = {
			"models/combine_helicopter/bomb_debris_3.mdl", "models/combine_helicopter/bomb_debris_1.mdl",
...
if true then local it = "ba_meat"
	local ITEM = {
		...
		Type = "Bait",
		Model = {
			"models/Gibs/Antlion_gib_Large_2.mdl", "models/gibs/antlion_gib_large_1.mdl",
...
if true then local it = "ba_magnet"
	local ITEM = {
		Name = "#xdefm."..it,
		Type = "Bait",
		Model = "models/props_phx/wheels/magnetic_med_base.mdl",
		Helper = "#xdefm.d"..it,
		Rarity = 4,
		Consume = 25,
...
if SERVER then local ba = "*"
    	...
    	xdefm_PoolAdd( { Items = { "it_water", "it_junks", "it_shoe", "it_mine1", "it_hula", "it_cactus", "it_combine" },	Exp = 10, 	Chances = { [ba] = 300 } 	} )
	xdefm_PoolAdd( { Items = { "it_brick", "it_health", "it_armor", "it_bugs", "it_monitor", "it_bouncy", "it_propane" }, 	Exp = 10, 	Chances = { [ba] = 300 } 	} )
...
if SERVER then local ba = "ba_wrench"
	xdefm_PoolAdd( { Items = { "it_furniture1", "it_pottery" }, 				Exp = 5, 	Chances = { [ba] = 200 } 	} )
   	...
   	xdefm_PoolAdd( { Items = { "it_radio", "it_jumppad", "it_chealth", "it_carmor" },	Exp = 20, 	Chances = { [ba] = 800 }, 	DepthMin = 3 	} )
	xdefm_PoolAdd( { Items = { "it_potter2", "it_potter3", "it_furnace1", "it_cooler" },	Exp = 20, 	Chances = { [ba] = 800 }, 	DepthMin = 3 	} )
